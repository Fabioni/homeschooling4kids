			...
			<div class="">
                ...
                if ( have_posts() ) {
	                ...
	                foreach ( $terms as $sk ) {
		                ...
		                if ( have_posts() ) {
			                ?>
                            <div class="section-content clear col-2 archivunterteil archivUnterteiltitel-<?= $sk->slug ?>"><h1 class="archivUnterteiltitel"><a
                                    href="<?= get_term_link( $sk->slug, "spasskategorie" ) ?>"><?= $sk->name ?></a></h1><?php
