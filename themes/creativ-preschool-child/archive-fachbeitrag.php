            ...
            <div class="">
                ...
                if (! is_tax("leistungsstufe")){
                    ...
                    <div style="width: fit-content; margin: auto;" class="leistungsstufen-toggle">
                        <label style="cursor: pointer" id="leistungsstufe1Label" class="btn"><input style="display: none" id="leistungsstufe1Radio" type="radio" name="leistungsstufe" value="1&2">1. & 2. Klasse</label>
                        <label style="cursor: pointer" id="leistungsstufe2Label" class="btn"><input style="display: none" id="leistungsstufe2Radio" type="radio" name="leistungsstufe" value="3&4">3. & 4. Klasse</label>
                        <label style="cursor: pointer" id="leistungsstufeAllesLabel" class="btn"><input checked="checked" style="display: none" id="leistungsstufeAllesRadio" type="radio" name="leistungsstufe" value="3&4">Alle Klassen</label>
                    </div>
                    <?php
                }
                ?>
				...
				if (isset($_GET['korrektur']) && $_GET['korrektur'] == "true") {
					$argsFut = array_merge( $wp_query->query_vars, array( 'post_status' => array("future", "publish") ) );
					query_posts( $argsFut );
				}
